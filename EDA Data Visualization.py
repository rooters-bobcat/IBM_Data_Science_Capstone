{
  ...
  "cells": [
    ...
    {
      "cell_type": "code",
      "source": "# HINT use groupby method on Orbit column and get the mean of Class column\ngrouped_data = df.groupby('Orbit')['Class'].mean().reset_index(inplace=True)\ngrouped_data",
      "metadata": {
        "trusted": true
      },
      "outputs": [],
    ...
    {
      "cell_type": "code",
      "source": "sns.barplot(x='Orbit', y='Class', data=grouped_data)",
      "metadata": {
        "trusted": true
      },
      "outputs": [],
    ...
    {
      "cell_type": "code",
      "source": "# Plot a line chart with x axis to be the extracted year and y axis to be the success rate\ngrouped_df = df.groupby('Date')['Class'].mean('Class')\ngrouped_df = pd.DataFrame(grouped_df)\ngrouped_df.reset_index(inplace=True)\ngrouped_df\nsns.lineplot(x='Date', y='Class', data=grouped_df)\nplt.xlabel(\"Date\",fontsize=20)\nplt.ylabel(\"Success Rate\",fontsize=20)\nplt.show()",
      "metadata": {
        "trusted": true
      },
      "outputs": [],
